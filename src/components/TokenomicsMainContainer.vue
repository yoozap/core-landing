...
<style scoped>
  ...
  .bottom__description-text{
    font-size: 15px;
    line-height: 24px;
    display: flex;
    align-items: center;
  }
  .bottom__description-text svg{
    margin-right: 10px;
  }
  .bottom__description-ttl{
    font-size: 15px;
    color: #FF7152;
    line-height: 24px;
    margin-bottom: 5px;
